...
const _clearLineMap = process.env.CLEAR_DEBUG ? {"334":33,"337":37,"353":57,"354":57,"357":58,"359":58,"368":60,"369":60,"372":61,"374":61,"383":63,"384":63,"390":64,"393":29,"394":29,"402":73,"403":73,"404":74,"414":76,"415":76,"420":77,"422":78,"425":78,"427":79,"438":83,"439":83,"447":84,"449":92,"450":92,"451":93,"453":101,"454":101,"455":102,"457":110,"458":110,"459":111,"461":119,"462":119,"463":120,"476":199,"478":200,"485":201,"487":202,"492":204,"494":205} : null;
// ┌─────────────────────────────────────────────┐
...
//   PUT /api/leads/:id [auth] (line 76)
//   POST /api/seed (line 83)
//
// PAGES:
//   'Lead Router' at / (line 124)
//
...
const _clearMap = process.env.CLEAR_DEBUG ? {
  ...
  endpoints: {
    ...
    "PUT /api/leads/:id": { line: 76, file: "main.clear", auth: true },
...
app.post('/api/leads', async (req, res) => {
  try {
    ...
    // clear:73
    const new_lead = await _clearTry(() => db.insert('leads', _pick(lead, LeadsSchema)), { op: 'insert', table: 'leads', line: 73, file: 'main.clear', source: "" }); // clear:73
    // clear:74
...
app.put('/api/leads/:id', async (req, res) => {
  try {
    ...
    await _clearTry(() => db.update('leads', _picked_lead), { op: 'update', table: 'leads', line: 78, file: 'main.clear', source: "" }); // clear:78
    Object.assign(lead, await db.findOne('leads', { id: _picked_lead.id }) || {});
    // clear:79
    return res.status(200).json({ message: "updated" });
  } catch (err) {
    console.error('[PUT /api/leads/:id] Error:', err.message);
    const _ctx = Object.assign({ endpoint: 'PUT /api/leads/:id', line: 76, file: 'main.clear' }, err._clearCtx || {});
    if (typeof process !== 'undefined' && process.env.CLEAR_DEBUG === 'verbose') _ctx.input = req.body;
    const _info = _clearError(err, _ctx);
    res.status(_info.status).json(_info.response);
  }
...
app.post('/api/seed', async (req, res) => {
  try {
    ...
    // clear:92
    l1 = await _clearTry(() => db.insert('leads', _pick(l1, LeadsSchema)), { op: 'insert', table: 'leads', line: 92, file: 'main.clear', source: "" }); // clear:92
    // clear:93
    ...
    // clear:101
    l2 = await _clearTry(() => db.insert('leads', _pick(l2, LeadsSchema)), { op: 'insert', table: 'leads', line: 101, file: 'main.clear', source: "" }); // clear:101
    // clear:102
    ...
    // clear:110
    l3 = await _clearTry(() => db.insert('leads', _pick(l3, LeadsSchema)), { op: 'insert', table: 'leads', line: 110, file: 'main.clear', source: "" }); // clear:110
    // clear:111
    ...
    // clear:119
    l4 = await _clearTry(() => db.insert('leads', _pick(l4, LeadsSchema)), { op: 'insert', table: 'leads', line: 119, file: 'main.clear', source: "" }); // clear:119
    // clear:120
