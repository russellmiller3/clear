...
//
// TABLES:
//   Sheets: title*, code*, created_at (line 51)
//   Messages: role*, content*, sheet_id*, created_at (line 56)
//
// ENDPOINTS:
//   GET /api/sheets (line 65)
//   POST /api/sheets (line 69)
//   POST /api/chat (line 76)
//   GET /api/chat (line 82)
//
// PAGES:
//   'Cast' at / (line 87)
//
...
app.post('/api/sheets', async (req, res) => {
  try {
    ...
    const new_sheet = await db.insert('sheets', _pick(sheet, SheetsSchema)); // clear:73
...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    if (_vErr) return res.status(400).json({ error: _vErr });
    const new_message = await db.insert('messages', _pick(message, MessagesSchema)); // clear:79
