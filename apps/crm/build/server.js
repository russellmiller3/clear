...
app.post('/api/activities', async (req, res) => {
  try {
    ...
    if (_vErr) return res.status(400).json({ error: _vErr });
    const new_activity = await db.insert('activitys', _pick(activity_data, ActivitySchema));
