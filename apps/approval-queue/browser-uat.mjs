...
const CONTRACT = {
  ...
  "controls": [
    {
      "id": "nav_item_130_Pending",
      "kind": "nav-item",
      "label": "Pending",
      "line": 130,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"nav_item_130_Pending\"]",
      "action": {
        "type": "navigate",
        "targetRoute": "/"
      },
    ...
    {
      "id": "nav_item_131_All_requests",
      "kind": "nav-item",
      "label": "All requests",
      "line": 131,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"nav_item_131_All_requests\"]",
      "action": {
        "type": "navigate",
        "targetRoute": "/"
      },
    ...
    {
      "id": "button_138_Refresh",
      "kind": "button",
      "label": "Refresh",
      "line": 138,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"button_138_Refresh\"]",
      "action": {
        "type": "api-call",
        "method": "GET",
    ...
    {
      "id": "button_147_Refresh",
      "kind": "button",
      "label": "Refresh",
      "line": 147,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"button_147_Refresh\"]",
      "action": {
        "type": "api-call",
        "method": "GET",
        "path": "/api/requests/pending"
    ...
    {
      "id": "table_interaction_170_Pending",
    ...
    {
      "id": "table_drilldown_170_Pending",
    ...
    {
      "id": "button_180_Approve",
      "kind": "button",
      "label": "Approve",
      "line": 180,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"button_180_Approve\"]",
      "action": {
        "type": "state-change"
      }
    },
    {
      "id": "button_182_Reject",
      "kind": "button",
      "label": "Reject",
      "line": 182,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"button_182_Reject\"]",
      "action": {
        "type": "state-change"
      }
    },
    {
      "id": "button_191_Submit",
      "kind": "button",
      "label": "Submit",
      "line": 191,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"button_191_Submit\"]",
      "action": {
        "type": "api-call",
        "method": "POST",
        "path": "/api/requests"
