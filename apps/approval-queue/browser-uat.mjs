...
// Contract version: 1
// Pages: 1, controls: 13, apiCalls: 7
...
const CONTRACT = {
  ...
  "controls": [
    {
      "id": "nav_item_131_Pending",
      "kind": "nav-item",
      "label": "Pending",
      "line": 131,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"nav_item_131_Pending\"]",
      "action": {
        "type": "navigate",
        "targetRoute": "/"
      },
    ...
    {
      "id": "nav_item_132_All_requests",
      "kind": "nav-item",
      "label": "All requests",
      "line": 132,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"nav_item_132_All_requests\"]",
      "action": {
        "type": "navigate",
        "targetRoute": "/"
      },
    ...
    {
      "id": "button_139_Refresh",
      "kind": "button",
      "label": "Refresh",
      "line": 139,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"button_139_Refresh\"]",
      "action": {
        "type": "api-call",
        "method": "GET",
    ...
    {
      "id": "button_148_Refresh",
      "kind": "button",
      "label": "Refresh",
      "line": 148,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"button_148_Refresh\"]",
      "action": {
        "type": "api-call",
        "method": "GET",
        "path": "/api/requests/pending"
    ...
    {
      "id": "table_interaction_171_Pending",
    ...
    {
      "id": "table_drilldown_171_Pending",
    ...
    {
      "id": "button_181_Approve",
      "kind": "button",
      "label": "Approve",
      "line": 181,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"button_181_Approve\"]",
      "action": {
        "type": "api-call",
        "method": "PUT",
    ...
    {
      "id": "button_186_Reject",
      "kind": "button",
      "label": "Reject",
      "line": 186,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"button_186_Reject\"]",
      "action": {
        "type": "api-call",
        "method": "PUT",
    ...
    {
      "id": "input_control_195_Description",
      "kind": "input-control",
      "label": "Description",
      "line": 195,
      "sourcePageRoute": "/",
    ...
    {
      "id": "input_control_196_Amount____",
      "kind": "input-control",
      "label": "Amount ($)",
      "line": 196,
      "sourcePageRoute": "/",
    ...
    {
      "id": "input_control_197_Requester",
      "kind": "input-control",
      "label": "Requester",
      "line": 197,
      "sourcePageRoute": "/",
    ...
    {
      "id": "button_198_Submit",
      "kind": "button",
      "label": "Submit",
      "line": 198,
      "sourcePageRoute": "/",
      "selector": "[data-clear-uat-id=\"button_198_Submit\"]",
      "action": {
        "type": "api-call",
        "method": "POST",
        "path": "/api/requests"
