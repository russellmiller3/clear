...
//
// TABLES:
//   Clients: name*, email*!, company, phone, created_at_date (line 13)
//   Invoices: client_id*, invoice_number*!, status, due_date, subtotal, tax_rate, tax_amount, total, notes, created_at_date (line 20)
//   LineItems: invoice_id*, description*, quantity*, unit_price*, line_total, created_at_date (line 32)
//   Payments: invoice_id*, amount*, method*, reference, created_at_date (line 40)
//   AuditLog: entity_type*, entity_id*, action*, detail, created_at_date (line 47)
//
// ENDPOINTS:
//   GET /api/clients (line 65)
//   GET /api/clients/:id (line 69)
//   POST /api/clients [auth] (line 74)
//   PUT /api/clients/:id [auth] (line 84)
//   DELETE /api/clients/:id [auth] (line 94)
//   GET /api/invoices (line 104)
//   GET /api/invoices/:id (line 108)
//   POST /api/invoices [auth] (line 113)
//   PUT /api/invoices/:id/send [auth] (line 127)
//   PUT /api/invoices/:id/pay [auth] (line 136)
//   PUT /api/invoices/:id/cancel [auth] (line 151)
//   DELETE /api/invoices/:id [auth] (line 160)
//   GET /api/line-items (line 173)
//   POST /api/line-items [auth] (line 177)
//   DELETE /api/line-items/:id [auth] (line 187)
//   GET /api/payments [auth] (line 196)
//   GET /api/audit [auth] (line 205)
//   GET /api/reports/summary [auth] (line 215)
//   GET /api/health (line 225)
//
