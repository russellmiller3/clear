# [ARCHIVE] Clear v1 — PHILOSOPHY.md (frozen 2026-04-05)

> **Archived 2026-04-29.** Snapshot of the Clear design philosophy at session 9 — the 14-year-old test, one-op-per-line, no jargon, deterministic compilation, etc. Current version at `clear/PHILOSOPHY.md` has added rules since the fork.
>
> Original location: `cast/clear/PHILOSOPHY.md`
