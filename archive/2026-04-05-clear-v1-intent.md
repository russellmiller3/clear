# [ARCHIVE] Clear v1 — intent.md (authoritative spec, frozen 2026-04-05)

> **Archived 2026-04-29.** Snapshot of the Clear node-type spec at session 9. Current spec lives at `clear/intent.md` and has grown to 119+ node types — this version is frozen at the v1 surface. Historical reference for what the language looked like before the fork.
>
> Original location: `cast/clear/intent.md`
