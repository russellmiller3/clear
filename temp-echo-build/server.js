...
const _clearLineMap = process.env.CLEAR_DEBUG ? {"159":3,"160":3,"165":4} : null;
// ┌─────────────────────────────────────────────┐
// │         CLEAR APP — Architecture            │
// └─────────────────────────────────────────────┘
//
// ENDPOINTS:
//   POST /api/echo (line 3)
//
...
const _clearMap = process.env.CLEAR_DEBUG ? {
  endpoints: {
    "POST /api/echo": { line: 3, file: "main.clear", auth: false },
  }
} : null;

// clear:3
// clear:3 — POST /api/echo
app.post('/api/echo', async (req, res) => {
  try {
    ...
    const _ctx = Object.assign({ endpoint: 'POST /api/echo', line: 3, file: 'main.clear' }, err._clearCtx || {});
