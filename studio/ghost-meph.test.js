...
//
// Run: node studio/ghost-meph.test.js
// =============================================================================
...
(async () => {
  ...
  // parser is tested separately at studio/ghost-meph/cc-agent-stream-json.test.js
  // =========================================================================
  ...
  // studio/sessions/<session-id>.ndjson. Was previously gated behind
  ...
  assert(_resultPath === _testPath,
    `persistCcAgentTranscript returns studio/sessions/<sid>.ndjson path (got ${_resultPath})`);
