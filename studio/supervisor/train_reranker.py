...
Usage:
  node studio/supervisor/export-training-data.js --out=data.jsonl
  python studio/supervisor/train_reranker.py data.jsonl --out reranker
...
def main():
    ...
    if passing < args.min_passing:
        ...
        print(f'  node studio/supervisor/curriculum-sweep.js --workers=3')
        sys.exit(1)
