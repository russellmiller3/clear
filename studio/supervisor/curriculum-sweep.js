...
//
// Usage:
//   node studio/supervisor/curriculum-sweep.js                  (default: 3 workers, all tasks)
//   node studio/supervisor/curriculum-sweep.js --workers=2
//   node studio/supervisor/curriculum-sweep.js --tasks=hello-world,echo,calculator
//   node studio/supervisor/curriculum-sweep.js --dry-run        (no API calls — prints plan)
//   node studio/supervisor/curriculum-sweep.js --timeout=300    (seconds per task)
//   node studio/supervisor/curriculum-sweep.js --strict         (require test_pass=1, reject "said TC" alone)
//   node studio/supervisor/curriculum-sweep.js --per-level-stats
//
