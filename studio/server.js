...
// reranker.json from your training output into studio/supervisor/.
try {
...
// studio/cloud-routing/index.test.js.
...
// STATIC FILES
// =============================================================================
// Route studio.html BEFORE static (otherwise index.html wins)
...
app.get('/', (req, res) => {
  ...
  res.sendFile(join(__dirname, 'studio.html'), { dotfiles: 'allow' });
});
...
// seconds by studio.html. Returns whatever truth we have right now: how many
...
// to the parent window. studio.html relays them here. Meph reads them via the
...
// =============================================================================
// parseTestOutput + compileForEval moved to studio/meph-helpers.js so
...
// Thin wrapper — real impl in studio/meph-helpers.js. Pre-fills
...
app.post('/api/chat', async (req, res) => {
  ...
  // studio/meph-tools.js and the 28-case switch is gone. /api/chat
