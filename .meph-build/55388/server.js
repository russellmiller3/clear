...
const _clearLineMap = process.env.CLEAR_DEBUG ? {"172":3,"174":5,"182":10,"183":10,"189":11,"192":14,"193":14,"194":15,"204":17,"205":17,"208":18,"210":19,"212":20,"214":21,"216":22,"218":23} : null;
// ┌─────────────────────────────────────────────┐
...
app.get('/api/posts', async (req, res) => {
  try {
    ...
    // clear:20
    const found_post = (await db.findAll('posts', {}, { limit: 50 })).map(_revive);
    // clear:21
    return res.json(found_post);
    // clear:22
    const post = (await db.findAll('posts', {}, { limit: 50 })).map(_revive);
    // clear:23
