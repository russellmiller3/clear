...
const _clearLineMap = process.env.CLEAR_DEBUG ? {"151":3,"153":5,"159":8,"160":8,"163":9,"165":10,"174":12,"175":12,"180":13,"182":14,"183":14,"184":15,"186":16,"196":18,"197":18,"200":19} : null;
// ┌─────────────────────────────────────────────┐
// │         CLEAR APP — Architecture            │
// └─────────────────────────────────────────────┘
//
// TABLES:
//   Counters: action (line 5)
//
// ENDPOINTS:
...
const _clearMap = process.env.CLEAR_DEBUG ? {
  tables: {
    counters: { line: 5, file: "main.clear", fields: { action: { type: "text" } } },
  },
  endpoints: {
...
const CountersSchema = {
  action: { type: "text", default: "increment" }
};
...
app.post('/api/increment', async (req, res) => {
  try {
    ...
    // clear:14
    await _clearTry(() => db.insert('counters', _pick(entry, CountersSchema)), { op: 'insert', table: 'counters', line: 14, file: 'main.clear', source: "" }); // clear:14
    // clear:15
    let new_total = await db.aggregate('counters', 'COUNT', 'id', {});
    // clear:16
