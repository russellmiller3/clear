...
const _clearLineMap = process.env.CLEAR_DEBUG ? {"264":3,"266":5,"268":8,"277":14,"278":14,"284":15,"287":17,"288":17,"289":18,"299":20,"300":20,"303":21,"305":21,"314":23,"315":23,"318":24,"320":24,"329":26,"330":26,"335":27,"337":28,"340":28,"342":29} : null;
// ┌─────────────────────────────────────────────┐
// │         CLEAR APP — Architecture            │
// └─────────────────────────────────────────────┘
//
// TABLES:
//   Requests: title*, description, amount, status (line 8)
//
// ENDPOINTS:
...
//   'Approval Queue' at /queue (line 40)
//
...
const _clearMap = process.env.CLEAR_DEBUG ? {
  tables: {
    requests: { line: 8, file: "main.clear", fields: { title: { required: true, type: "text" }, description: { type: "text" }, amount: { type: "number" }, status: { type: "text" } } },
  },
  endpoints: {
...
app.post('/api/requests', async (req, res) => {
  try {
    ...
    // clear:17
    const saved = await _clearTry(() => db.insert('requests', _pick(request, RequestsSchema)), { op: 'insert', table: 'requests', line: 17, file: 'main.clear', source: "" }); // clear:17
    // clear:18
...
app.get("/queue", (req, res) => res.sendFile('index.html', { root: __dirname }));
