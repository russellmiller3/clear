...
app.post('/webhook/stripe', async (req, res) => {
  try {
    ...
    // clear:12
    if (!(event?.signature != null)) { return res.status(403).json({ error: "Missing signature" }); }
    // clear:13
    event.event_type = event?.type;
    // clear:14
    await _clearTry(() => db.insert('events', _pick(event, EventsSchema)), { op: 'insert', table: 'events', line: 14, file: 'main.clear', source: "" }); // clear:14
    // clear:15
