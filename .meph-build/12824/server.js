...
const _clearLineMap = process.env.CLEAR_DEBUG ? {"180":3,"182":5,"189":9,"190":9,"196":10,"199":12,"200":12,"201":13,"211":15,"212":15,"215":16,"217":17,"226":19,"227":19,"230":20,"232":21,"241":23,"242":23,"247":24,"249":25,"252":25,"254":26,"264":28,"265":28,"269":29,"271":30,"272":30,"273":31} : null;
// ┌─────────────────────────────────────────────┐
...
app.delete('/api/todos/:id', async (req, res) => {
  try {
    ...
    if (!req.user) { return res.status(401).json({ error: "Authentication required" }); }
    // clear:30
    await _clearTry(() => db.remove('todos', { id: incoming?.id }), { op: 'remove', table: 'todos', line: 30, file: 'main.clear', source: "" }); // clear:30
    // clear:31
