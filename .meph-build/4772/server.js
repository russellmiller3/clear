...
const _clearLineMap = process.env.CLEAR_DEBUG ? {"169":3,"171":5,"180":11,"181":11,"187":12,"190":17,"191":17,"192":18} : null;
// ┌─────────────────────────────────────────────┐
...
app.post('/api/register', async (req, res) => {
  try {
    ...
    // clear:17
    const saved = await _clearTry(() => db.insert('users', _pick(registration, UsersSchema)), { op: 'insert', table: 'users', line: 17, file: 'main.clear', source: "" }); // clear:17
    // clear:18
