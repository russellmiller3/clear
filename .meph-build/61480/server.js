...
const _clearLineMap = process.env.CLEAR_DEBUG ? {"134":2,"136":4,"137":4,"140":5} : null;
// ┌─────────────────────────────────────────────┐
// │         CLEAR APP — Architecture            │
// └─────────────────────────────────────────────┘
//
// ENDPOINTS:
//   GET /api/hello (line 4)
//
...
const _clearMap = process.env.CLEAR_DEBUG ? {
  endpoints: {
    "GET /api/hello": { line: 4, file: "main.clear", auth: false },
  }
} : null;
...
app.get('/api/hello', async (req, res) => {
  try {
    ...
    const _ctx = Object.assign({ endpoint: 'GET /api/hello', line: 4, file: 'main.clear' }, err._clearCtx || {});
