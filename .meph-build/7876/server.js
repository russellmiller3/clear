...
async function agent_summarizer(text) {
  // clear:4
  let result = await _askAI("You are a summarization expert. Create a concise summary and extract key points from the provided text.", text, [{"name":"summary","type":"text"},{"name":"key_points","type":"text"}], null);
  // clear:7
  return result;
}
// clear:9
...
app.post('/api/summarize', async (req, res) => {
  try {
    ...
    // clear:10
    let response = await agent_summarizer(request?.text);
    // clear:11
