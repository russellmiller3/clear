...
const _clearLineMap = process.env.CLEAR_DEBUG ? {"160":5,"161":5,"166":6} : null;
// ┌─────────────────────────────────────────────┐
// │         CLEAR APP — Architecture            │
// └─────────────────────────────────────────────┘
//
// ENDPOINTS:
//   POST /api/echo (line 5)
//
...
const _clearMap = process.env.CLEAR_DEBUG ? {
  endpoints: {
    "POST /api/echo": { line: 5, file: "main.clear", auth: false },
  }
} : null;

// Echo Server — returns whatever JSON body was sent to it
// clear:5
// clear:5 — POST /api/echo
app.post('/api/echo', async (req, res) => {
  try {
    ...
    console.error('[POST /api/echo] Error:', err.message);
    const _ctx = Object.assign({ endpoint: 'POST /api/echo', line: 5, file: 'main.clear' }, err._clearCtx || {});
