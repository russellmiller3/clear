...
const _clearLineMap = process.env.CLEAR_DEBUG ? {"151":3,"153":5,"159":8,"160":8,"163":9,"165":10,"174":12,"175":12,"180":13,"181":13,"182":14,"184":15,"194":17,"195":17,"198":18} : null;
// ┌─────────────────────────────────────────────┐
...
const _clearMap = process.env.CLEAR_DEBUG ? {
  tables: {
    ticks: { line: 5, file: "main.clear", fields: { value: { type: "number" } } },
  },
  endpoints: {
...
app.post('/api/increment', async (req, res) => {
  try {
    ...
    const tick = req.body;
    // clear:13
    await _clearTry(() => db.insert('ticks', _pick(tick, TicksSchema)), { op: 'insert', table: 'ticks', line: 13, file: 'main.clear', source: "" }); // clear:13
    // clear:14
    let total = await db.aggregate('ticks', 'COUNT', 'id', {});
    // clear:15
    return res.json({ count: total });
