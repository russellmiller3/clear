...
Updated: **2026-04-26 (shell Phase 2 adds explicit sidebar nav syntax + curriculum/eval signal; overnight autonomous run closed the WIN-data asymmetry and unblocked regression measurement)**.
