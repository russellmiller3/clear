...
Updated: **2026-04-25 night → 26 morning (overnight autonomous run: winner-harvest scorer + held-out test set close the WIN-data asymmetry; sweep cleanup helper unblocks regression measurement; decidable-core `live:` keyword foundation lands)**.
