...
- Full shell upgrade remaining phases — detail panel and Marcus app port. See `plans/plan-full-shell-upgrade-04-25-2026.md`; Phase 4 stat cards landed, Phase 6 detail panel is next.
