...
const _clearLineMap = process.env.CLEAR_DEBUG ? {"159":3,"160":3,"165":4,"167":6,"174":11,"178":14,"182":17,"186":20} : null;
// ┌─────────────────────────────────────────────┐
// │         CLEAR APP — Architecture            │
// └─────────────────────────────────────────────┘
//
// ENDPOINTS:
//   POST /api/calculate (line 3)
//
...
const _clearMap = process.env.CLEAR_DEBUG ? {
  endpoints: {
    "POST /api/calculate": { line: 3, file: "main.clear", auth: false },
  }
} : null;

// clear:3
// clear:3 — POST /api/calculate
app.post('/api/calculate', async (req, res) => {
  try {
    ...
    console.error('[POST /api/calculate] Error:', err.message);
    const _ctx = Object.assign({ endpoint: 'POST /api/calculate', line: 3, file: 'main.clear' }, err._clearCtx || {});
